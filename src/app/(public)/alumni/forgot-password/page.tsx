...
import { alumniForgotPasswordAction } from "@/lib/actions/alumni-actions";
import { initialActionState } from "@/lib/actions/types";
import { Label, inputClasses, FormAlert } from "@/components/ui/Common";
import { Button } from "@/components/ui/Button";

export default function AlumniForgotPasswordPage() {
  const [state, formAction, isPending] = useActionState(alumniForgotPasswordAction, initialActionState);
          ...
          {state.success ? (
            <div className="text-center">
              ...
              <p className="text-sm text-slate mt-2 leading-relaxed">
                If an alumni account exists for that email address, we&apos;ve sent a link to reset your password.
                It expires in 30 minutes.
              </p>
              <Link href="/alumni" className="inline-block mt-6 text-sm font-semibold text-primary-800 hover:text-accent-600">
